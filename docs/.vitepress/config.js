        ...
        items: [
          {
            ...
            collapsed: false,
            items: [
              { text: "介绍", link: "/os-interfaces/index" },
              {
                text: "进程和内存",
          ...
          },
          {
            ...
            collapsed: true,
            items: [
              { text: "介绍", link: "/page-tables/index" },
              ...
              { text: "Sbrk", link: "/page-tables/code-sbrk" },
          ...
          },
          {
            ...
            collapsed: true,
            items: [
              { text: "介绍", link: "/traps-and-syscalls/index" },
              {
                text: "RISC-V 陷阱机制",
          ...
          },
          {
            ...
            collapsed: true,
            items: [
              { text: "介绍", link: "/interrupts-and-drivers/index" },
              {
                text: "驱动程序中的并发",
          ...
          },
          {
            ...
            collapsed: true,
            items: [
              { text: "介绍", link: "/file-system/index" },
          ...
          },
          {
            ...
            collapsed: true,
            items: [
              { text: "介绍", link: "/concurrency-revisited/index" },
          ...
          },
          {
            text: "总结",
            collapsed: true,
            items: [{ text: "介绍", link: "/summary/index" }],
          },
        ],
      },
    ],
